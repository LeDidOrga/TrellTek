...
export async function updateOrganization(organizationId, displayName, desc, name, website) {
    try {
        const response = await trelloClient.put(`/organizations/${organizationId}`, {}, {
            params: {
                displayName,
                desc,
                name,
...
export async function deleteOrganization(organizationId) {
    try {
        const response = await trelloClient.delete(`/organizations/${organizationId}`);
        return response.data;
    } catch (error) {
